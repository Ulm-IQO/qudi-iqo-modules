...
# how to realize this function ?
    ...
    def transform_spherical_Bfield(self,B,theta,phi):
        # the input field is in mT, the generated output is then in T
        Bx = math.cos(math.radians(phi))*math.sin(math.radians(theta))*B/1000
        By = math.sin(math.radians(phi))*math.sin(math.radians(theta))*B/1000
        Bz = math.cos(math.radians(theta))*B/1000

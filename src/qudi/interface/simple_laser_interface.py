...
class SimpleLaserInterface(Base):
    ...
    def get_current(self):
        ...
        -------
        float
            laser current in current units
        """
        pass
    ...
    def allowed_control_modes(self):
        ...
        -------
        frozenset
            set of supported ControlMode enums
        """
        pass
    ...
    def get_temperatures(self):
        ...
        -------
        dict
            dict of temperature names and value in degrees Celsius
        """
        pass

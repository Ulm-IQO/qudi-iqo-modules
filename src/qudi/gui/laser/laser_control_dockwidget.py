...
class LaserControlDockWidget(AdvancedDockWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.power_spinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        self.power_spinbox.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        ...
        self.power_slider = DoubleSlider(QtCore.Qt.Orientation.Vertical)
        self.power_slider.set_granularity(10000)  # 0.01% precision
        self.power_slider.setMinimumHeight(200)
        self.power_slider.setSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred,
        ...
        self.current_spinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        self.current_spinbox.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        ...
        self.current_slider = DoubleSlider(QtCore.Qt.Orientation.Vertical)
        ...
        self.current_slider.setSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred,
                                          QtWidgets.QSizePolicy.Policy.Expanding)
        layout.addWidget(self.current_slider)
        main_layout.addWidget(group_box, 2, 1)
        main_widget.setSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Expanding)

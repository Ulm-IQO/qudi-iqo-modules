...
try:
    from qudi.logic.mfl_irq_driven import MFL_IRQ_Driven
    from qudi.logic.mfl_xy8_irq_driven import MFL_IRQ_Driven as MFL_XY8_IRQ_Driven
    from qudi.logic.mfl_multi_irq_driven import MFL_Multi_IRQ_Driven
except:
    pass
try:
